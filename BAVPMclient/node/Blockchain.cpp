                                  ...
                                  const QString& msgvalue)
{
    ...
    resultObject.insert("gas",  "0xfffff");
    resultObject.insert("data", data) ;
    resultObject.insert("value",msgvalue);//wei
...
// len(a) is the number of bytes in a binary string a. The type of len(a) is assumed to be
